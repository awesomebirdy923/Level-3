package com.league.level3.massacre;
	...
	private void findTheDiamond() {
		...
		for(Crow crow : theMurder){
			if(crow.getStomachContents().contains("diamond")){
				System.out.println(crow.getName() + " has eaten the diamond!!");
			} else{
//				System.out.println(crow.getName() + " is innocent.");
				innocents++;
				
			}
		}
		System.out.println(innocents + " are innocent.");
